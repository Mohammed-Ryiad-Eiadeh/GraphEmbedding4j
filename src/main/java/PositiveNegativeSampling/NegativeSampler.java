 ...
 */
public sealed interface NegativeSampler permits UniformNegativeSampler {
     ...
     */
    List<TrainingPair> generateNegativePairs(int target, Set<Integer> forbidden, int numOfNegativeSamples);
}
