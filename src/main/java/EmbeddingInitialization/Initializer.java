 ...
 */
public sealed abstract class Initializer<V> permits EmbeddingInitializer {
     ...
     */
    public Initializer(ImmutableGraphData<V> immutableGraphData, int embeddingDimension, long seed) {
