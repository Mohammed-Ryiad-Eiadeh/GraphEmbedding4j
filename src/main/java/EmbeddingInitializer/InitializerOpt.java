 ...
 */
public sealed abstract class InitializerOpt<V> permits EmbeddingInitializerOpt {
     ...
     */
    public InitializerOpt(ImmutableGraphData<V> immutableGraphData, int embeddingDimension, long seed) {
